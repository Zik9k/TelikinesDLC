...
public final class TracersSettingsScreen extends Screen {
    private static final int WIDTH = 520;
    private static final int HEIGHT = 300;
    private final TracersModule module;
    private final Screen parent;
    private boolean draggingRange;

    public TracersSettingsScreen(TracersModule module, Screen parent) {
        super(Text.literal("Tracers Settings"));
        this.module = module;
        this.parent = parent;
    }
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawText(textRenderer, Text.literal("Tracers"), left + 20, top + 17, 0xFFF4EEF9, false);
        context.drawText(textRenderer, Text.literal("Render settings"), left + 88, top + 18, 0xFF776E7E, false);
        ...
        context.drawText(textRenderer, Text.literal("Tracer distance"), left + 22, top + 180, 0xFFBDB4C4, false);
    ...
    private void updateRange(double mouseX) {
        int left = left();
        module.setRange(8 + (int) Math.round(120.0 * Math.max(0.0, Math.min(1.0, (mouseX - (left + 22)) / (double) (WIDTH - 44)))));
    }
